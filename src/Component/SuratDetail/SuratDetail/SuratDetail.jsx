...
const SuratDetail = () => {
    ...
    //Trigger event scrollTo jika element telah di Load
    useEffect( () => {
        if (isLoad) {
            scrollTo();
        }
                    ...
                    <>
                        ...
                        <main className="w-full p-9 min-h-[90dvh]">    
                            ...
                            {ayats['ayat'].map( (ayat) => {
                                ...
                                return(
                                    <div id={ `${ bookmarked ? "book" : ""}` } className={ `${ bookmarked ? "border-[#4632b8] shadow-lg ring-4" : "border-black" } flex-grow gap-2 flex flex-col p-5  relative rounded-md  justify-between border mb-2`} key={ayat['nomorAyat']}>
                                        <div className='w-fit'>
                                        ...
                                        <div className="flex w-full justify-end mb-2">
                                            <p className="break-words max-w-[30ch] min-w-[10ch] ml-14 text-3xl sm:text-4xl text-right font-arab" >{ ayat['teksArab'] }</p>
                                        </div>
                        
                                        <div className="flex justify-between w-fit items-center mb-2">
                                            <p className='break-words max-w-[75ch] text-justify'>
